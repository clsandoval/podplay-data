---
jira_key: KAN-21
jira_url: https://kosmaskavc.atlassian.net/browse/KAN-21
project: KAN
type: jira-issue
issue_type: Task
status: Backlog
...
# MLP Philippines Planning Summary

## 1) Current status

- Contract with MLP for the Philippines is expected to be signed very soon.
- Kim and I aligned on proposing a team to Mr. Uytengsu as a father-and-son project.
- I emailed Mr. Uytengsu this morning and am awaiting his response.

## 2) Next steps

- Prepare a concise, investor-ready presentation deck for MLP Philippines, including vision, structure, and proposed team involvement.
- Align internally on key terms and expectations for the partnership with MLP in the Philippines.
